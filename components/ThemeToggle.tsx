...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="grid h-8 w-8 place-items-center overflow-hidden rounded-full border border-edge text-mute transition-colors duration-200 hover:border-text/40 hover:bg-panel2 hover:text-text"
    >
